...
def extract_descriptions_and_metadata(data):
    ...
    for item in data:
        # Extract description (metadata content)
...
def build_event_clusters_from_faiss(vector_db, high_threshold=0.6):
...
def main():
    ...
    output_dir = "event_alignment_metadata"
    ...
    # Save clusters
    output_file = os.path.join(output_dir, "event_alignment_metadata.jsonl")
